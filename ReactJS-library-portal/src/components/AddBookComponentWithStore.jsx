...
class AddBookComponentWithStore extends Component {
    constructor(props) {
        super(props);
        this.name = "";
        this.author = "";
    ...
    componentDidUpdate() {
        console.log("Add book component updated");
    }
...
export default connectToStore(mapStateToProps)(AddBookComponentWithStore);